...
for {set y 0} {$y < $num_y} {incr y} {
  for {set x 0} {$x < $num_x} {incr x} {
    ...
    floo_narrow_wide_chimney_wave $tb_name/$noc_name/cluster_ni_${x}_${y} [concat $groups [list Chimney]]
...
for {set y 0} {$y < $num_y} {incr y} {
  floo_narrow_wide_chimney_wave $tb_name/$noc_name/hbm_ni_${y} [list HBM West "Channel ${y}" Chimney] 1
}
