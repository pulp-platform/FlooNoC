...
module tb_floo_rob_multicast;
  ...
  // Only the reserved collective ops are used
  typedef logic [$clog2(NumReservedCollectOps)-1:0] collect_op_t;
  `FLOO_TYPEDEF_HDR_T(hdr_t, id_t, id_t, axi_ch_e, rob_idx_t, id_t, collect_op_t)
