    ...
    for (genvar ch = 0; ch < NumNWAxiChannels; ch++) begin : gen_id_mask
      ...
      if ((en_narrow_collective(CollectOpCfg) && Ch == NarrowAw) ||
        ...
        if (RouteCfg.UseIdTable &&
            floo_pkg::is_xy_family(RouteCfg.RouteAlgo)) begin: gen_collecttive_idtable
        ...
        end else if (floo_pkg::is_xy_family(RouteCfg.RouteAlgo)) begin: gen_collective_noidtable
