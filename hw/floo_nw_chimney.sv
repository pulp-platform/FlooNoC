...
#(
  ...
  collect_op_e axi_narrow_req_in_red_op;
  collect_op_e axi_wide_req_in_red_op;
  ...
  collect_op_e axi_narrow_red_op_queue;
  collect_op_e axi_wide_red_op_queue;
  ...
  if (ChimneyCfgN.EnMgrPort) begin : gen_narrow_sbr_port
    ...
    if (ChimneyCfgN.CutAx) begin : gen_ax_cuts
      ...
      if (en_narrow_collective(CollectOpCfg)) begin : gen_collective_cuts
        ...
        assign axi_narrow_red_op_queue = collect_op_e'('0);
      end
  ...
  if (ChimneyCfgW.EnMgrPort) begin : gen_wide_sbr_port
    ...
    if (ChimneyCfgW.CutAx) begin : gen_ax_cuts
      ...
      if (en_wide_collective(CollectOpCfg)) begin : gen_collective_cuts
        ...
        assign axi_wide_red_op_queue = collect_op_e'('0);
      end
  ...
  collect_op_e [NumNWAxiChannels-1:0] red_coll_operation;
  collect_op_e red_narrow_coll_operation_q;
  collect_op_e red_wide_coll_operation_q;
  ...
  assign red_coll_operation[NarrowAr] = collect_op_e'('0);
  assign red_coll_operation[WideAw]   = axi_wide_red_op_queue;
  assign red_coll_operation[WideAr]   = collect_op_e'('0);
  assign red_coll_operation[NarrowW]  = red_narrow_coll_operation_q;
  assign red_coll_operation[WideW]    = red_wide_coll_operation_q;
  assign red_coll_operation[NarrowR]  = collect_op_e'('0);
  assign red_coll_operation[NarrowB]  = collect_op_e'('0);
  assign red_coll_operation[WideR]    = collect_op_e'('0);
  assign red_coll_operation[WideB]    = collect_op_e'('0);

  // Store the collective operation to be used for the incoming W beat!
  `FFL(red_narrow_coll_operation_q, axi_narrow_red_op_queue,
      axi_narrow_aw_queue_valid_out && axi_narrow_aw_queue_ready_in, collect_op_e'('0))
  `FFL(red_wide_coll_operation_q, axi_wide_red_op_queue,
      axi_wide_aw_queue_valid_out && axi_wide_aw_queue_ready_in, collect_op_e'('0))
  ...
  always_comb begin
    ...
    floo_narrow_ar.hdr.collective_op   = collect_op_e'('0);
  end
  ...
  always_comb begin
    ...
    floo_narrow_r.hdr.collective_op   = collect_op_e'('0);
  end
  ...
  always_comb begin
    ...
    floo_wide_ar.hdr.collective_op   = collect_op_e'('0);
  end
  ...
  always_comb begin
    ...
    floo_wide_r.hdr.collective_op    = collect_op_e'('0);
  end
